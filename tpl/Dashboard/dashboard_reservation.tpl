...
<div class="reservation row {$class}" id="{$reservation->ReferenceNumber}" {if isset($orangePending) && $orangePending == false}style="background-color:white;"{/if}>
     {*doesn't show pending reservations as orange in Pending Approval Reservations in the dashboard*}
